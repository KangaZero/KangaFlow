...
function DialogContent({
  ...
  // The Content focus/escape/pointer handlers ride in `...props` (kept optional,
  // not re-passed as explicit `undefined` — exactOptionalPropertyTypes). `asChild`
  // forwards them onto motion.div via the Slot; Radix consumes the dialog ones.
  return (
