...
const en = {
  ...
  environment: {
    ...
    settings: {
      ...
      autoHideBar: "Auto-hide bar",
      barBottom: "Bottom",
      barLeft: "Left",
      barOpacity: "Bar opacity",
      barPosition: "Bar position",
      barRadius: "Bar corners",
      barRight: "Right",
      barTop: "Top",
      ...
      fontMono: "Mono",
      fontSans: "Sans",
      launcherRadius: "Launcher corners",
      ...
      toastDuration: "Auto-close duration",
      toastDuration3s: "3 s",
      toastDuration5s: "5 s",
      toastDuration8s: "8 s",
      toastDuration12s: "12 s",
      toastMaxStack: "Max stack",
      toastMaxStack1: "1",
      toastMaxStack3: "3",
      toastMaxStack5: "5",
      toastMaxStack8: "8",
      ...
      widgetAnchorBottomLeft: "Bottom left",
      widgetAnchorBottomRight: "Bottom right",
      widgetAnchorCenter: "Center",
      widgetAnchorTopLeft: "Top left",
      widgetAnchorTopRight: "Top right",
      widgetApplyCurrent: "Apply current",
      widgetOpenToApply: "Open the widget to capture its position",
      widgetPosition: "Default position",
      widgetResetPosition: "Reset",
      widgetShowStartup: "Show on startup",
      widgets: "Widgets",
      widgetsSoon: "Widget settings coming soon.",
      windowRadius: "Window corners",
    },
    title: "Environment",
    window: {
      close: "Close window",
  ...
  notifications: {
    ...
    localeSwitchedToEn: "Switched to English",
    localeSwitchedToJa: "日本語に切り替えました",
    reminder: "Reminder",
    remindIn5: "5 min",
    remindIn10: "10 min",
    remindIn15: "15 min",
  ...
  settings: {
    actions: {
      ...
      toggleHints: "Link hints (Vimium f)",
